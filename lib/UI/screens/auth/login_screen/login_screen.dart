      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Container(),
            Container(
              padding: EdgeInsets.only(left: 14.w, top: 17.h),
              child: Text(
                'Welcome\nBack',
                        ...
                        children: [
                          TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                filled: true,
                                hintText: "Email",
                                hintStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.sp),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => forget_password_screen()));
                                  },
                                  child: Text(
                                    'Forgot Password',
                                    style: TextStyle(
